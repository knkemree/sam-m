...
class Product(models.Model): 
    ...
    image = models.ImageField(upload_to='products/%Y/%m/%d', blank=True, default= 'img/logo.png', help_text="System may give an error if product cover image does not exist")
