...
class VariationResource(resources.ModelResource):
    ...
    class Meta:
        ...
        fields = ('product','product__category','product__color','child_collection','product__category__parent','product__image','product__available','id','sku','title','price','cost','sale_price','ecomdashid','active')
        export_order = ('product','product__category','product__color','child_collection','product__category__parent','product__image','product__available','id','sku','title','price','cost','sale_price','ecomdashid','active')
        #exclude = ('id', )
    ...
    def before_import_row(self, row, **kwargs):
        ...
        Product.objects.get_or_create(name=row['product'], category=row['product__category'])
